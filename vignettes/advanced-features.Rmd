...
pdf_path <- file.path(output_dir, "baseline_characteristics_cropped.pdf")
...
pdf_path <- file.path(output_dir, "anova_table_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "endpoints_table_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "treatment_comparison_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "longitudinal_outcomes_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "subgroup_analysis_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "adverse_events_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "summary_stats_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "regression_coefs_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "efficacy_results_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
...
pdf_path <- file.path(output_dir, "clinical_efficacy_cropped.pdf")
if (file.exists(pdf_path)) {
  knitr::include_graphics(pdf_path)
}
```
