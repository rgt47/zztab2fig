...
This creates:
- `output/basic_iris.tex`: LaTeX source file
- `output/basic_iris.pdf`: Full PDF 
- `output/basic_iris_cropped.pdf`: Cropped PDF for inclusion

## Custom Colors and Styling

Control table appearance with different color schemes:
...
# Blue-gray corporate style
t2f(small_iris,
    filename = "corporate_table",
    scolor = "blue!8")

# Red accent for attention-grabbing tables
t2f(small_iris,
    filename = "accent_table", 
    scolor = "red!10")
```
...
Include generated PDFs in R Markdown documents:
...
t2f(summary_data, "summary", sub_dir = "tables")
```

![Summary Statistics](tables/summary_cropped.pdf)
````
