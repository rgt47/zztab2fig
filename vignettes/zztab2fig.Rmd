...
- **S3 method dispatch**: `t2f()` now works directly with `lm`, `glm`, `anova`,
  `aov`, `htest`, `matrix`, and `table` objects
...
- **Caption and label support**: LaTeX captions with short captions and
...
- *Advanced Features* - Footnotes, headers, alignment, and placement helpers
