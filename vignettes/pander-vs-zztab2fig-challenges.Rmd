...
## Extensibility: t2f_tidy() for Any Object

While pander supports 50+ object types natively, zztab2fig provides `t2f_tidy()`
as an escape hatch for any object supported by the broom package:
```r
library(randomForest)
rf <- randomForest(Species ~ ., data = iris)
t2f_tidy(rf, filename = "rf_importance")
```

This means zztab2fig can handle most statistical objects through broom, while
...
- **S3 methods**: 15 native methods + extensible via broom and t2f_tidy()
