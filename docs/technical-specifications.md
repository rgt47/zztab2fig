...
│   ├── broom-methods.R       # broom-based S3 methods (survival, lme4, etc.)
│   ├── rms-methods.R         # RMS package S3 methods (v0.2.1)
...
| `rms` | Regression Modeling Strategies integration |
...
| RMS Package | ols, lrm, cph, orm, Glm, psm | Coefficient/ANOVA output |
